...
function CodenameOneExec() {
    ...
    var callbackId = null;
    //alert("In CodenameOneExec "+arguments[0]);
    ...
    */
   //alert("About to call CN1Exec");
   //alert(window.CN1Exec);
   window.CN1Exec.apply(window, [callbackId, service, action, JSON.stringify(actionArgs)]);
   //window.location.href = "/!cn1command/ca_weblite_codename1_js_JavascriptContext_LOOKUP_TABLE0[0].CN1Exec?String=10&String=bar";
}
...
module.exports = CodenameOneExec;
...
if (!window.console) {
    window.console = {
        log: function(){alert.apply(window, arguments);}
    };
}
...
function findCordovaPath() {
    ...
    var term = 'cordova.js';
    for (var n = 0; n <= scripts.length-1; n++) {
...
exports.load = function(callback) {
    ...
    //alert("about to inject plugin/list "+pathPrefix + 'cordova_plugins.js');
    injectIfNecessary('cordova/plugin_list', pathPrefix + 'cordova_plugins.js', function() {
        //alert("found cordova_plugins.js");
